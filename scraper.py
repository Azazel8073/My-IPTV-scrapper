...
USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) IPTV-Parser-Engine/4.0"
...
def main():
    print(f"Connecting to target endpoint via raw text pipeline: {SUBREDDIT_RSS_URL}")
    ...
    # 1. FIXED ENDPOINT STRUCTURE: Stripped of any trailing symbols
    ...
    # 2. ROBUST TEXT REGEX ENGINE (Replaces fragile XML Parsing blocks)
    raw_html_content = response.text
    
    # Isolate individual <entry> blocks using broad string boundary patterns
    ...
    for block in entry_blocks:
        # Extract everything inside the title and content markers safely
        ...
        # Pull continuous string layouts matching base64 properties
        ...
        for base64_chunk in potential_blocks:
            ...
            if decoded:
                # Track down paste vectors inside the text footprint
